...
import { isP2PMode } from './serverConfig';
...
class ApiSocket {
    ...
    connect() {
        ...
        // In P2P mode allow both websocket and polling transports
        // for better compatibility over LAN/HTTP connections
        const transports = isP2PMode()

...
export const MetadataSchema = z.object({
    ...
    remcliHomeDir: z.string().optional(), // Remcli configuration directory 
...
export const MachineMetadataSchema = z.object({
    ...
    remcliHomeDir: z.string(), // Directory for Remcli auth, settings, logs (usually .remcli/ or .remcli-dev/)

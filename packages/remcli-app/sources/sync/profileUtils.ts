...
export OPENAI_SMALL_FAST_MODEL="gpt-5.3"`,
            };
        case 'azure-openai':
            return {
    ...
    switch (id) {
        case 'anthropic':
            return {
                ...
                compatibility: { claude: true, codex: false, cursor: false, gemini: false },
                isBuiltIn: true,
                createdAt: Date.now(),
                updatedAt: Date.now(),
                version: '1.0.0',
        ...
        case 'openai':
            return {
                ...
                environmentVariables: [
                    ...
                    { name: 'OPENAI_SMALL_FAST_MODEL', value: 'gpt-5.3' },
                    { name: 'API_TIMEOUT_MS', value: '600000' },
                    { name: 'CODEX_SMALL_FAST_MODEL', value: 'gpt-5.3' },
                ],

...
export function showMicrophonePermissionDeniedAlert(canAskAgain: boolean = false) {
  ...
  const message = canAskAgain
    ? 'Remcli needs access to your microphone for voice chat. Please grant permission when prompted.'
    : 'Remcli needs access to your microphone for voice chat. Please enable microphone access in your device settings.';

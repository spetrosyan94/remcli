...
/**
 * Spanish translations for the Remcli app
...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'Remcli es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
    ...
    newSession: {
        ...
        noMachinesFound: 'No se encontraron máquinas. Inicia una sesión de Remcli en tu computadora primero.',
        ...
        resumeSessionEmpty: 'No se encontraron sesiones anteriores',
        resumeSessionEmptyHint: 'Inicia una nueva sesión primero, luego podrás reanudarla',
        resumeSessionUntitled: 'Sesión sin título',
        resumeSessionMessages: ({ count }: { count: number }) => count === 1 ? '1 mensaje' : `${count} mensajes`,
        resumeSessionFailed: 'No se pudo reanudar la sesión',
    },
    ...
    sessionInfo: {
        ...
        remcliSessionIdCopied: 'ID de sesión de Remcli copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar ID de sesión de Remcli',
        remcliSessionId: 'ID de sesión de Remcli',
        ...
        remcliHome: 'Directorio de Remcli',
        ...
        updateCliInstructions: 'Por favor ejecute npm install -g remcli@latest',
    ...
    agentInput: {
        ...
        model: {
            ...
            defaultDesc: 'Modelo predeterminado del agente',
        ...
        cursorPermissionMode: {
            ...
            yolo: 'Forzar',
            badgePlan: 'Modo plan',
            badgeReadOnly: 'Modo preguntas',
            badgeYolo: 'Modo forzar',
        },
        context: {
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de Remcli. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
    ...
    machine: {
        ...
        offlineHelp: '• Asegúrate de que tu computadora esté en línea\n• Ejecuta `remcli daemon status` para diagnosticar\n• ¿Estás usando la última versión del CLI? Actualiza con `npm install -g remcli@latest`',
    ...
    whisper: {
        ...
        noSpeechDetected: 'No se reconoció voz en la grabación. Inténtalo de nuevo.',
        setupRequired: 'Entrada de voz no disponible',
        setupRequiredDescription: 'Ejecute remcli setup para habilitar la entrada de voz.',
    },
    microphone: {
        accessRequired: 'Se requiere acceso al micrófono',
        grantPermission: 'Remcli necesita acceso a tu micrófono para el chat de voz. Concede el permiso cuando se te solicite.',
        enableInSettings: 'Remcli necesita acceso a tu micrófono para el chat de voz. Habilita el acceso al micrófono en los ajustes de tu dispositivo.',
        httpsRequired: 'El micrófono requiere una conexión segura (HTTPS). Inicia el daemon con la bandera --tunnel para habilitar la entrada de voz: remcli daemon start --tunnel',
        webInstructionsSafari: 'Cuando el navegador solicite acceso al micrófono, toca "Permitir". Si lo denegaste, ve a Ajustes \u2192 Safari \u2192 Micrófono y permite para este sitio.',
        webInstructionsChrome: 'Cuando el navegador solicite acceso al micrófono, toca "Permitir". Si lo denegaste, toca el icono de configuración del sitio (a la izquierda de la barra de direcciones) y habilita el micrófono.',
        webInstructionsGeneric: 'Cuando el navegador solicite acceso al micrófono, toca "Permitir". Si lo denegaste, revisa los ajustes de tu navegador para habilitar el micrófono en este sitio.',

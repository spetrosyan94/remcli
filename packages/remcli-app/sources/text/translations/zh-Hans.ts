/**
 * Chinese (Simplified) translations for the Remcli app
 * Values can be:
...
export const zhHans: TranslationStructure = {
    ...
    settings: {
        ...
        about: '关于',
        aboutFooter: 'Remcli 是一个 Codex 和 Claude Code 移动客户端。它采用端到端加密，您的账户仅存储在本地设备上。与 Anthropic 无关联。',
        whatsNew: '更新日志',
        ...
        termsOfService: '服务条款',
        eula: '最终用户许可协议',
        supportUs: '支持我们',        supportUsSubtitle: '支持项目开发',
    ...
    newSession: {
        ...
        title: '启动新会话',
        noMachinesFound: '未找到设备。请先在您的计算机上启动 Remcli 会话。',
    ...
    sessionInfo: {
        ...
        remcliSessionIdCopied: 'Remcli 会话 ID 已复制到剪贴板',
        failedToCopySessionId: '复制 Remcli 会话 ID 失败',
        remcliSessionId: 'Remcli 会话 ID',
        ...
        updateCliInstructions: '请运行 npm install -g remcli@latest',
        deleteSession: '删除会话',
    ...
    terminal: {
        ...
        terminalRequestDescription: '有终端正在请求连接到您的 Remcli 账户。这将允许终端安全地发送和接收消息。',
    ...
    machine: {
        ...
        offlineHelp: '• 确保您的计算机在线\n• 运行 `remcli daemon status` 进行诊断\n• 您是否在运行最新的 CLI 版本？请使用 `npm install -g remcli@latest` 升级',
        daemon: '守护进程',
        status: '状态',
        stopDaemon: '停止守护进程',
    ...
    whisper: {
        ...
        noSpeechTitle: '未检测到语音',
        noSpeechDetected: '未能识别录音中的语音，请重试。',

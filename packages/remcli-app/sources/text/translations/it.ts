...
/**
 * Italian translations for the Remcli app
...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'Remcli è un client mobile per Codex e Claude Code. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
        whatsNew: 'Novità',
        ...
        eula: 'EULA',
        supportUs: 'Sostienici',        supportUsSubtitle: 'Sostieni lo sviluppo del progetto',
    ...
    newSession: {
        ...
        noMachinesFound: 'Nessuna macchina trovata. Avvia prima una sessione Remcli sul tuo computer.',
        ...
        resumeSessionEmpty: 'Nessuna sessione precedente trovata',
        resumeSessionEmptyHint: 'Avvia prima una nuova sessione, poi potrai riprenderla',
        resumeSessionUntitled: 'Sessione senza titolo',
        resumeSessionMessages: ({ count }: { count: number }) => count === 1 ? '1 messaggio' : `${count} messaggi`,
        resumeSessionFailed: 'Impossibile riprendere la sessione',
    },
    ...
    sessionInfo: {
        ...
        remcliSessionIdCopied: 'ID sessione Remcli copiato negli appunti',
        failedToCopySessionId: 'Impossibile copiare l\'ID sessione Remcli',
        remcliSessionId: 'ID sessione Remcli',
        ...
        updateCliInstructions: 'Esegui npm install -g remcli@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Installa la CLI Remcli',
            runIt: 'Avviala',
    ...
    agentInput: {
        ...
        model: {
            ...
            default: 'Predefinito',
            defaultDesc: 'Modello predefinito dell\'agente',
            mostCapable: 'Più potente',
            balanced: 'Bilanciato',
            fast: 'Veloce',
            fastest: 'Più veloce',
        },
        ...
        cursorPermissionMode: {
            title: 'MODALITÀ CURSOR',
            default: 'Agente',
            plan: 'Piano',
            readOnly: 'Chiedi',
            yolo: 'Forza',
            badgePlan: 'Modalità piano',
            badgeReadOnly: 'Modalità domande',
            badgeYolo: 'Modalità forza',
        },
        context: {
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminale richiede di connettersi al tuo account Remcli. Questo consentirà al terminale di inviare e ricevere messaggi in modo sicuro.',
    ...
    machine: {
        ...
        offlineHelp: '• Assicurati che il tuo computer sia online\n• Esegui `remcli daemon status` per diagnosticare\n• Stai usando l\'ultima versione della CLI? Aggiorna con `npm install -g remcli@latest`',
        daemon: 'Daemon',
        status: 'Stato',

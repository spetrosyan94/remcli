/**
 * Japanese translations for the Remcli app
 * Values can be:
...
export const ja: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'このアプリについて',
        aboutFooter: 'RemcliはCodexとClaude Codeのモバイルクライアントです。完全なエンドツーエンド暗号化を採用し、アカウントはデバイスにのみ保存されます。Anthropicとは提携していません。',
        whatsNew: '新機能',
    ...
    newSession: {
        ...
        title: '新しいセッションを開始',
        noMachinesFound: 'マシンが見つかりません。まずコンピューターでRemcliセッションを起動してください。',
    ...
    sessionInfo: {
        ...
        remcliSessionIdCopied: 'Remcli Session IDがクリップボードにコピーされました',
        failedToCopySessionId: 'Remcli Session IDのコピーに失敗しました',
        ...
        updateCliInstructions: 'npm install -g remcli@latest を実行してください',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'ターミナルがRemcliアカウントへの接続を要求しています。これにより、ターミナルは安全にメッセージを送受信できるようになります。',
    ...
    machine: {
        ...
        offlineHelp: '• コンピューターがオンラインであることを確認してください\n• `remcli daemon status`を実行して診断してください\n• 最新のCLIバージョンを使用していますか？`npm install -g remcli@latest`でアップグレードしてください',
        daemon: 'デーモン',
        status: 'ステータス',
        stopDaemon: 'デーモンを停止',
    ...
    whisper: {
        ...
        noSpeechTitle: '音声が検出されません',
        noSpeechDetected: '録音から音声を認識できませんでした。もう一度お試しください。',

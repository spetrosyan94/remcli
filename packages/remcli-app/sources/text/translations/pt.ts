...
/**
 * Portuguese (Brazilian) translations for the Remcli app
...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Remcli é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
        ...
        eula: 'EULA',
        supportUs: 'Nos apoie',        supportUsSubtitle: 'Apoie o desenvolvimento do projeto',
    ...
    newSession: {
        ...
        noMachinesFound: 'Nenhuma máquina encontrada. Inicie uma sessão Remcli no seu computador primeiro.',
        ...
        resumeSessionEmpty: 'Nenhuma sessão anterior encontrada',
        resumeSessionEmptyHint: 'Inicie uma nova sessão primeiro, depois poderá retomá-la',
        resumeSessionUntitled: 'Sessão sem título',
        resumeSessionMessages: ({ count }: { count: number }) => count === 1 ? '1 mensagem' : `${count} mensagens`,
        resumeSessionFailed: 'Falha ao retomar sessão',
    },
    ...
    sessionInfo: {
        ...
        remcliSessionIdCopied: 'ID da sessão Remcli copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão Remcli',
        remcliSessionId: 'ID da sessão Remcli',
        ...
        updateCliInstructions: 'Por favor execute npm install -g remcli@latest',
    ...
    agentInput: {
        ...
        model: {
            ...
            default: 'Padrão',
            defaultDesc: 'Modelo padrão do agente',
        ...
        cursorPermissionMode: {
            ...
            readOnly: 'Perguntar',
            yolo: 'Forçar',
            badgePlan: 'Modo plano',
            badgeReadOnly: 'Modo perguntas',
            badgeYolo: 'Modo forçar',
        },
        context: {
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta Remcli. Isso permitirá que o terminal envie e receba mensagens com segurança.',
    ...
    machine: {
        ...
        offlineHelp: '• Verifique se seu computador está online\n• Execute `remcli daemon status` para diagnosticar\n• Você está usando a versão mais recente do CLI? Atualize com `npm install -g remcli@latest`',
    ...
    microphone: {
        accessRequired: 'Acesso ao microfone necessário',
        grantPermission: 'O Remcli precisa de acesso ao seu microfone para o chat de voz. Conceda a permissão quando solicitado.',
        enableInSettings: 'O Remcli precisa de acesso ao seu microfone para o chat de voz. Ative o acesso ao microfone nas configurações do dispositivo.',
        httpsRequired: 'O microfone requer uma conexão segura (HTTPS). Inicie o daemon com a flag --tunnel para habilitar a entrada de voz: remcli daemon start --tunnel',
        webInstructionsSafari: 'Quando o navegador solicitar acesso ao microfone, toque em "Permitir". Se você negou, vá para Configurações \u2192 Safari \u2192 Microfone e permita para este site.',
        webInstructionsChrome: 'Quando o navegador solicitar acesso ao microfone, toque em "Permitir". Se você negou, toque no ícone de configurações do site (à esquerda da barra de endereços) e ative o microfone.',
        webInstructionsGeneric: 'Quando o navegador solicitar acesso ao microfone, toque em "Permitir". Se você negou, verifique as configurações do navegador para ativar o microfone para este site.',

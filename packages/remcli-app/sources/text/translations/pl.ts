...
/**
 * Polish translations for the Remcli app
...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'Remcli to mobilny klient Codex i Claude Code. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
        whatsNew: 'Co nowego',
        ...
        eula: 'EULA',
        supportUs: 'Wesprzyj nas',        supportUsSubtitle: 'Wesprzyj rozwój projektu',
    ...
    newSession: {
        ...
        noMachinesFound: 'Nie znaleziono maszyn. Najpierw uruchom sesję Remcli na swoim komputerze.',
    ...
    sessionInfo: {
        ...
        remcliSessionIdCopied: 'ID sesji Remcli skopiowane do schowka',
        failedToCopySessionId: 'Nie udało się skopiować ID sesji Remcli',
        remcliSessionId: 'ID sesji Remcli',
        ...
        remcliHome: 'Katalog domowy Remcli',
        ...
        updateCliInstructions: 'Proszę uruchomić npm install -g remcli@latest',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem Remcli. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
    ...
    machine: {
        ...
        offlineHelp: '• Upewnij się, że komputer jest online\n• Uruchom `remcli daemon status`, aby zdiagnozować\n• Czy używasz najnowszej wersji CLI? Zaktualizuj poleceniem `npm install -g remcli@latest`',
    ...
    whisper: {
        ...
        noSpeechTitle: 'Nie wykryto mowy',
        noSpeechDetected: 'Nie rozpoznano mowy w nagraniu. Spróbuj ponownie.',

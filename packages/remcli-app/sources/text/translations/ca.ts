...
/**
 * Catalan translations for the Remcli app
...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'Remcli és un client mòbil de Codex i Claude Code. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
        whatsNew: 'Novetats',
    ...
    newSession: {
        ...
        noMachinesFound: 'No s\'han trobat màquines. Inicia una sessió de Remcli al teu ordinador primer.',
        ...
        resumeSessionEmpty: 'No s\'han trobat sessions anteriors',
        resumeSessionEmptyHint: 'Inicia una nova sessió primer, després podràs reprendre-la',
        resumeSessionUntitled: 'Sessió sense títol',
        resumeSessionMessages: ({ count }: { count: number }) => count === 1 ? '1 missatge' : `${count} missatges`,
        resumeSessionFailed: 'No s\'ha pogut reprendre la sessió',
    },
    ...
    sessionInfo: {
        ...
        remcliSessionIdCopied: 'ID de la sessió de Remcli copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de Remcli',
        remcliSessionId: 'ID de la sessió de Remcli',
        ...
        remcliHome: 'Directori de Remcli',
        ...
        updateCliInstructions: 'Si us plau executeu npm install -g remcli@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instal·la el Remcli',
            runIt: 'Executa\'l',
    ...
    agentInput: {
        ...
        model: {
            ...
            default: 'Per defecte',
            defaultDesc: 'Model per defecte de l\'agent',
            mostCapable: 'Més capaç',
            balanced: 'Equilibrat',
            fast: 'Ràpid',
            fastest: 'Més ràpid',
        },
        ...
        cursorPermissionMode: {
            ...
            yolo: 'Forçar',
            badgePlan: 'Mode pla',
            badgeReadOnly: 'Mode preguntes',
            badgeYolo: 'Mode forçar',
        },
        context: {
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal està sol·licitant connectar-se al teu compte de Remcli. Això permetrà al terminal enviar i rebre missatges de forma segura.',
    ...
    machine: {
        ...
        offlineHelp: '• Assegura\'t que l\'ordinador estigui en línia\n• Executa `remcli daemon status` per diagnosticar\n• Fas servir l\'última versió del CLI? Actualitza amb `npm install -g remcli@latest`',
    ...
    whisper: {
        ...
        noSpeechTitle: 'No s\'ha detectat veu',
        noSpeechDetected: 'No s\'ha reconegut la veu a la gravació. Torna-ho a provar.',

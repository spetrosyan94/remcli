/**
 * English translations for the Remcli app
 * Values can be:
...
export const en = {
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'Remcli is a Codex and Claude Code mobile client. It\'s fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic.',
        whatsNew: 'What\'s New',
    ...
    newSession: {
        ...
        noMachinesFound: 'No machines found. Start a Remcli session on your computer first.',
    ...
    sessionInfo: {
        ...
        remcliSessionIdCopied: 'Remcli Session ID copied to clipboard',
        failedToCopySessionId: 'Failed to copy Remcli Session ID',
        ...
        updateCliInstructions: 'Please run npm install -g remcli@latest',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'A terminal is requesting to connect to your Remcli account. This will allow the terminal to send and receive messages securely.',
    ...
    machine: {
        ...
        offlineHelp: '• Make sure your computer is online\n• Run `remcli daemon status` to diagnose\n• Are you running the latest CLI version? Upgrade with `npm install -g remcli@latest`',
        daemon: 'Daemon',
        status: 'Status',

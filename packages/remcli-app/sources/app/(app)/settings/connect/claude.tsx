...
export default function ClaudeOAuth() {
    ...
    return (
        <>
            <OAuthViewUnsupported name="Claude" command="remcli connect claude" />
            {/* <OAuthView
                name="Claude"
                command="remcli connect claude"
...
const OAuthViewUnsupported = React.memo((props: {
    ...
    const command = props.command || `remcli connect ${props.name.toLowerCase()}`;

/**
 * Installation script for Remcli daemon using macOS LaunchDaemons
 * 
 * NOTE: This installation method is currently NOT USED in favor of auto-starting 
 * the daemon when the user runs the remcli command. 
 * 
 ...
 * 2. We assume users will run remcli frequently (every time they open their laptop)
    ...
    try {
        ...
        const plistContent = trimIdent(`
            ...
            <dict>
                ...
                <string>${os.homedir()}/.remcli/daemon.err</string>
                
                <key>StandardOutPath</key>
                <string>${os.homedir()}/.remcli/daemon.log</string>
        ...
        logger.info('Check logs at ~/.remcli/daemon.log');

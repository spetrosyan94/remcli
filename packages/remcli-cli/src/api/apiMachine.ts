/**
 * WebSocket client for machine/daemon communication with Remcli server
...
export class ApiMachineClient {
    ...
    setRPCHandlers({
        ...
        this.rpcHandlerManager.registerHandler('spawn-remcli-session', async (params: any) => {
    ...
    connect() {
        const serverUrl = getEffectiveServerUrl().replace(/^http/, 'ws');

 ...
 *
 * This module defines the message format expected by the Remcli mobile app.
 * Messages from any agent (Gemini, Codex, Claude, etc.) are transformed
 * to this format before being sent through the Remcli server.
 *
 ...
 */
export type MobileAgentType = 'gemini' | 'codex' | 'claude' | 'opencode' | 'cursor';

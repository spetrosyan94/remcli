...
[общему single-writer контракту Remcli](shared-live-chat-architecture.md) и
использует `@earendil-works/pi-tui` только как UI-библиотеку. Pi agent runtime
и Pi provider в Cursor flow не участвуют.
